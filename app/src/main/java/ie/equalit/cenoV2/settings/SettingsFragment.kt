...
import ie.equalit.cenoV2.R.string.pref_key_privacy
import ie.equalit.cenoV2.R.string.pref_key_remote_debugging
//import ie.equalit.cenoV2.R.string.pref_key_sign_in
        ...
        return OnPreferenceClickListener {
            ...
            AlertDialog.Builder(context).apply {
                ...
                setPositiveButton(R.string.customize_addon_collection_ok) { _, _ ->
                    ie.equalit.cenoV2.settings.Settings.setOverrideAmoUser(
                        context,
                        userView.text.toString()
                    )
                    ie.equalit.cenoV2.settings.Settings.setOverrideAmoCollection(
                        context,
                ...
                collectionView.setText(
                    ie.equalit.cenoV2.settings.Settings.getOverrideAmoCollection(
                        context
                    )
                )
                userView.setText(ie.equalit.cenoV2.settings.Settings.getOverrideAmoUser(context))
