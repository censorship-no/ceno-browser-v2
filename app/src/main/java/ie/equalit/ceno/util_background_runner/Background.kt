package ie.equalit.ceno.util_background_runner

import ie.equalit.ceno.util_background_runner.model.BackgroundDocument
import ie.equalit.ceno.util_background_runner.model.BackgroundResponse
import ie.equalit.ceno.util_background_runner.model.BackgroundTab
...
object Background {
    ...
    fun escapeHtml(s: String): String {
        return s.replace(Regex("[&<>\"']")) { c -> htmlEscapes[c.value]!! }
    }
    ...
    fun getDhtGroup(e: BackgroundDocument): String? {
        // https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/webRequest/onBeforeSendHeaders
        var url: String? = e.documentUrl ?: e.url ?: return null
    ...
    // https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/API/webRequest/onBeforeSendHeaders
//    fun onBeforeSendHeaders(e: BackgroundTab): Map<String, MutableMap<String, String?>>? {
//        if (e.tabId < 0) {
//            return null
//        }
//
...
//            e.requestHeaders.putAll(mapOf("name" to "X-Ouinet-Private", "value" to (if (is_private) "True" else "False")))
//
//            if (!is_private) {
//                e.requestHeaders.putAll(mapOf("name" to "X-Ouinet-Group", "value" to getDhtGroup(e)))
//            }
//
...
//    }
//
//    fun redirect403ToHttps(e: BackgroundResponse) : Any {
